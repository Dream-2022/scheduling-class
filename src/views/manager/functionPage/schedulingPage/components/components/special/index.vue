...
const buttonList = ref([
  ...
  { label: '科目天内排课次数限制', value: 4, name: 'subjectDayLimit' },
  { label: '教师周内节次限制', value: 5, name: 'teacherWeekLimit' },
  { label: '教师特定节次限制', value: 6, name: 'teacherRestrictions' },
  { label: '科目特定节次限制', value: 7, name: 'subjectRestrictions' },
  { label: '教师上下午限制', value: 8, name: 'teacherMorningAfternoon' },
  { label: '科目上下午限制', value: 9, name: 'subjectMorningAfternoon' },
  { label: '教师天内任课限制', value: 10, name: 'teacherDayLimit' },
  { label: '合班课设置', value: 11, name: 'jointClass' },
  { label: '教师连排', value: 12, name: 'teacherRow' },
  // { label: '教师禁止连堂', value: 14, name: 'teacherProhibitedRow' },
  { label: '班级固定教室', value: 13, name: 'classClassroom' },
  { label: '多学时课程连续排', value: 14, name: 'continuousScheduling' },
])
//所有限制内容
