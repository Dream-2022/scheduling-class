  ...
  <div class="activity-container">
    <div class="activity-left">
      <div class="wow animate__fadeInLeft warn-box">
        ...
        教室时间段禁排：设置教室在特定时间段不能排课，如教室维修、设备检修等
      </div>
...
const prohibitionList = ref(props.allContent.classroomProhibition || [])
...
const handleSearch = () => {
  if (!selectedArr.value || selectedArr.value.length === 0) {
    prohibitionList.value = props.allContent.classroomProhibition || []
    return
  }

  prohibitionList.value = (props.allContent.classroomProhibition || []).filter(item => {
